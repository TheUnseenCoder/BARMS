...
public class SignUpChoices extends AppCompatActivity {
    ...
    void sendDataToServer(final String email, final String fullName) {
        // Log message indicating that sendDataToServer method is called
        Log.d("SignUpChoices", "Sending data to server...");

        // Instantiate the RequestQueue
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
        String url = "https://capstone-it4b.com/epcr/barms/includes/google.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                // Handle error
                Log.e("Error", "Error sending data: " + error.getMessage(), error);
